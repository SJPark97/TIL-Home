...
- 튜플
  - 항상 소괄호 형태로 사용
    ...
    - 값에 대한 접근은 tuple[i]
    - 리스트와의 차이점은 생성 후, 담고 있는 값 변경이 불가 -> 불변 자료형![image-20220718222156773](README.assets/image-20220718222156773.png)
- Range의 정의
  - 숫자의 시퀀스를 나타내기 위해 사용
  - 주로 반복문과 함께 사용됨![image-20220718222404181](README.assets/image-20220718222404181.png)
  - range(n)
    - 0부터 n-1까지의 숫자의 시퀀스
  - range(n, m)
    - n부터 m-1까지의 숫자의 시퀀스
...
- 슬라이싱 연산자
  - 예제
  - ![image-20220718224043125](README.assets/image-20220718224043125.png)
  - ![image-20220718224052926](README.assets/image-20220718224052926.png)
  - ![image-20220718224101086](README.assets/image-20220718224101086.png)
  - ![image-20220718224113771](README.assets/image-20220718224113771.png)
- 셋(set)
  ...
  - ![image-20220718224543410](README.assets/image-20220718224543410.png)
- 딕셔너리
  - ![image-20220718224951436](README.assets/image-20220718224951436.png)
  - 중괄호({}) 혹은 dict()을 통해 생성
  - key를 통해 value에 접근![image-20220718225027702](README.assets/image-20220718225027702.png)
- 형 변환
  - 파이썬에서는 데이터 형태는 서로 변환할 수 있음
  - 암시적 형 변환
    - 사용자가 의도하지 않고, 파이썬 내부적으로 자료형을 변환하는 경우
    - ![image-20220718225121557](README.assets/image-20220718225121557.png)
  - 명시적 형 변환
    - 사용자가 특정 함수를 활용하여 의도적으로 자료형을 변환하는 경우
    - ![image-20220718225130723](README.assets/image-20220718225130723.png)
    - ![image-20220718225234825](README.assets/image-20220718225234825.png)
    - ![image-20220718225242579](README.assets/image-20220718225242579.png)
    - ![image-20220718225251569](README.assets/image-20220718225251569.png)
...
![image-20220719104024922](README.assets/image-20220719104024922.png)
